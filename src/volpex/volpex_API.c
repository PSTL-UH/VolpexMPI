...
int mpi_allreduce(void *sendbuf, void *recvbuf, int *count, MPI_Datatype *datatype, 
		  MPI_Op *op, MPI_Comm *comm, int *ierr)
{
...
int mpi_isend(void *buf, int *count, MPI_Datatype *datatype, int *dest, int *tag, 
	      MPI_Comm *comm, MPI_Request *request, int *ierr)
{
...
int  mpi_alltoall(void *sendbuf, int *sendcount, MPI_Datatype *sendtype, void *recvbuf, 
		  int *recvcount, MPI_Datatype *recvtype, MPI_Comm *comm, int *ierr)
{
...
int  mpi_alltoallv_  ( void *, int *, int *, MPI_Datatype *, void *, int *, int *, 
		       MPI_Datatype *, MPI_Comm *, int * );
int  mpi_alltoallv__ ( void *, int *, int *, MPI_Datatype *, void *, int *, int *, 
		       MPI_Datatype *, MPI_Comm *, int * );
int  MPI_ALLTOALLV   ( void *, int *, int *, MPI_Datatype *, void *, int *, int *, 
		       MPI_Datatype *, MPI_Comm *, int * );
